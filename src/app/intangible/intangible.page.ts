...
@Component({
  ...
  templateUrl: './intangible.page.html',
  styleUrls: ['./intangible.page.scss'],
})
export class IntangiblePage implements OnInit {
  items: any;
  edituser: any;
  dis: string;
  newbank='d-none';
  ...
  async modals(params, useful) {
    ...
    if (params == 'newbank') {
     ...
     let formdata = new FormData()
      ...
      formdata.set('receipt_type', 'iasset')
      formdata.set('id',this.id)
...
async getbanks() {
  ...
  alert.present();
  this.xhr.getbanks('iasset').subscribe((res: any) => {
